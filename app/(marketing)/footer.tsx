export default function Footer() {
  return (
    <footer className='hidden lg:block h-20 w-full border-slate-100 border-t-2 p-2'>
      <div className='max-w-screen-lg mx-auto flex items-center justify-center h-full gap-x-2'>
        <p className='text-xs'>Made whit 🧡 by AlejandroD.</p>
        <a href='https://github.com/aledx18' target='_blank' rel='noreferrer'>
          <svg viewBox='0 0 24 24' width='20' height='40'>
